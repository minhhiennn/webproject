...
<div class="container-fluid">
	...
	<div class="col-lg-6 mb-4">
		...
		%>
		<form action="http://localhost:8080/WebProject/AdminQuanLySanPham?productID=<%=product.getID()%>" method="post">
			<!-- Illustrations -->
				...
				<div class="card-body">
					...
					<div>
						<span style="padding-right: 84px;">Tên sản phẩm:</span> <input
							...
							style="width: 600px; padding: 3px" name="productName" disabled="disabled">
					</div>
					<hr>
					<div>
						<span style="padding-right: 80px;">Loại sản phẩm:</span> <input
							type="text" value=<%=product.getTypeproduct()%>
							style="width: 600px; padding: 3px" name="productType" disabled="disabled">
					</div>
					<hr>
					<div>
						<span style="padding-right: 68px;">Nhóm sản phẩm:</span> <input
							type="text" value=<%=product.getThuocnhom()%>
							style="width: 600px; padding: 3px" name="thuocnhom" disabled="disabled">
					</div>
					<hr>
					<div>
					...
					<hr>
					<div>
						<span style="padding-right: 125px;">Tồn kho:</span> <input type="text"
							name="productPrice" value=<%=product.getSoLuongTonKho()%>
							style="width: 600px; padding: 3px" disabled="disabled">
					</div>
				</div>
			</div>
			...
			<div class="card shadow mb-4" style="width: 205%">
				...
				<div class="card-body">
					...
					<div style="display: flex;">
						...
						<textarea rows="5" cols="72" disabled="disabled"><%=product.getDescription()%></textarea>
					</div>
				</div>
			...
			<div class="card shadow mb-4" style="width: 205%;">
				<div class="card-body">
					<div style="padding-left: 177px">
						<button type="submit" value="exitView" name="action"
