...
<title>Trả lời hỏi đáp thong ke</title>
	...
	<div class="col-lg-6 mb-4">
		...
		<div class="card shadow mb-4" style="width: 205%">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary" style="float: left;">Trả
					lời hỏi đáp</h6>
			...
			%>
			<form
				action="http://localhost:8080/WebProject/ThongKeHoiDap?action=gui&dateStart=<%=dateStart%>&dateEnd=<%=dateEnd%>"
				method="post">
				<div class="card-body">
					...
					<div style="padding-left: 6px">
						<span style="padding-right: 49px;">ID Khách Hàng:</span> <input
							name="idd" type="text" value=<%=list.get(i).getId()%>
					...
					<div style="display: flex;">
						...
						<textarea rows="3" cols="66" name="phanhoi11"
					...
					<div style="padding-left: 430px; margin-top: 35px">
						<button type="submit" name="phanhoi"
							style="border: none; background-color: #36b9cc; border-radius: 6px; margin-right: 10px; height: 40px; width: 80px; background-color: green">Gửi</button>
