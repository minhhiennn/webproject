...
<jsp:include page="header.jsp"></jsp:include>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Các Tiện Ích Khác</h1>
                    <p class="mb-4">
                        Các lớp tiện ích mặc định của Bootstrap có thể được tìm thấy trên trang chính thức <a
                            href="https://getbootstrap.com/docs">Bootstrap Documentation</a> . 
                            Các tiện ích tùy chỉnh
                                                    bên dưới được tạo để mở rộng chủ đề này qua các lớp tiện ích mặc định được tích hợp trong Bootstrap's
                                                    khuôn khổ.</p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Độ Cao Ẩn</h6>
                                </div>
                                <div class="card-body">
