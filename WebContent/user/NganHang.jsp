				...
				<div class="list_menu_pos_1"
					...
					<div class="list_menu_pos_1_2345"
						...
						<div style="display: block; padding: 0 0 3px 34px">
							<a style="display: block; margin-bottom: 15px" href="Account.html"> <span
			...
			<div class="content_all_right"
				...
				<div>
					<div class="my-account-section"
						style="display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; flex-direction: column; padding: 0 30px 20px; background: #fff; overflow: visible;">
						<div class="my-account-section_header"
							...
							<div class="my-account-section_header-left"
								...
								<div
									style="font-size: 1.125rem; font-weight: 500; line-height: 1.5rem; color: #333; text-transform: capitalize; display: block;">Thẻ
									tín dụng ghi nợ của tôi</div>
							</div>
						...
						<div
							...
							chưa có thẻ tín dụng ghi nợ</div>
						<div
							style="font-size: .875rem; line-height: 1.0625rem; color: #555; margin-top: 3px;"></div>
					</div>
					<div class="my-account-section"
						style="display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; flex-direction: column; padding: 0 30px 20px; background: #fff; overflow: visible;">
						<div class="my-account-section_header"
							...
							<div class="my-account-section_header-left"
								style="flex: 1; display: block;">
								<div
									style="font-size: 1.125rem; font-weight: 500; line-height: 1.5rem; color: #333; text-transform: capitalize; display: block;">Tài
									khoản ngân hàng của tôi</div>
								<div
									style="font-size: .875rem; line-height: 1.0625rem; color: #555; margin-top: 3px;"></div>
							</div>
							<div class="my-account-section_header-button"
						...
						<div
							style="color: #555; font-size: 1.125rem; padding: 90px 0; text-align: center; width: 100%; display: block;">Bạn
							chưa có tài khoản ngân hàng</div>
					</div>
				</div>
			</div>
		</div>
