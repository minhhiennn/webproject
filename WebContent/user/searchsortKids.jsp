				...
				<div class="col-md-9 col-sm-8">
									...
									<div class="single-item">
										<div class="product-item-img">
											<a
												...
												style="width: 264px; height: 180px;"> <img
												class="secondary-img" src=<%=listImg.get(1).getFileImg()%>
												alt="item" style="width: 264px; height: 180px;">
											</a>
					...
					<div class="shop-pagination floatright">
						<ul class="pagination">
							...
							<%
								String sortcode = (String) request.getAttribute("sortcode");
								int endPage = (Integer) request.getAttribute("endPage");
								for (int i = 0; i < endPage; i++) {
									String string = String.valueOf(i + 1);
							%>
							<li><a id=<%=string%>
								href="http://localhost:8080/WebProject/SearchSortServlet?index=<%=i + 1%>&search=<%=searchProduct%>&select=<%=selectform%>&sortcode=<%=sortcode%>"><%=(i + 1)%></a></li>
							<%
								}
							%>
